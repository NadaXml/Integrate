...
// power by https://github.com/Alex-Rachel/GameFramework-Next
...
namespace UnityGameFramework.Editor
{
    ...
    public static class OpenFolder
    {
        ...
        /// </summary>
        [MenuItem("Open Folder/Temporary Cache Path", false, 13)]
        ...
        /// </summary>
        [MenuItem("Open Folder/Console Log Path", false, 14)]
        ...
        public static void Execute(string folder)
        {
            ...
            switch (Application.platform)
            {
                ...
                default:
                    throw new Exception(string.Format("Not support open folder on '{0}' platform.", Application.platform));
            }
        }
    }
}
