using System;
namespace adt {
    public struct ActionValue : IComparable<ActionValue>, IEquatable<ActionValue> {
                /// <summary>
        /// 行动值：放大100倍的周期
        /// </summary>
        public int value;
        ...
        /// <returns></returns>
        public static ActionValue FromSpeed(in Attr speed) {
            return new ActionValue() {
                value = C_Action_Param / speed.valueFinal
            };
        }
